...
<div class="privacy_policy">
    <div class="container">
    <div class="content">
                <p>Effective date: 31st December, 2022</p>
                <h2>Introduction</h2>
                <!--<p><a href="https://cybercyld.com/Cookee">Cookie Usage, click here</a>.</p> -->
                <p>We take privacy seriously. We have anonymized IPs for Google Analytics and denied them access to use our data in any commercial way. We do not serve ads. We do not sell any data. All sensitive data that we receive will be deleted upon request or after a maximum of 14 days after a case is closed.</p>
                <p><a href="https://www.cyberwarriors.me/" target="_self" rel="follow noopener noreferrer" data-wpel-link="exclude">AppTwig Pvt. Ltd.</a> (“us”, “we”, or “our”) operates Cyberwarriors.me, (the “Service”).</p>
                <p>This page informs you of our policies regarding the collection, use, and disclosure of personal data when you use our Service and the choices you have associated with that data. Our Privacy Policy for AppTwig Pvt. Ltd. is managed through&nbsp;Free Privacy Policy.</p>
                <p>We use your data to provide and improve the Service. By using the Service, you agree to the collection and use of information in accordance with this policy. Unless otherwise defined in this Privacy Policy, terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, accessible from Cyberwarriors.me</p>
                ...
                <h2>Use Of Data</h2>
                <p>AppTwig Pvt. Ltd. uses the collected data for various purposes:</p>
                <ul>
                ...
                <p>AppTwig Pvt. Ltd. will take all steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organization or a country unless there are adequate controls in place including the security of your data and other personal information.</p>
                <p>&nbsp;</p>
                ...
                <p>write to us: info@cyberwarriors.me</p>
                <h2>Disclosure Of Data</h2>
                <h3>Legal Requirements</h3>
                <p>AppTwig Pvt. Ltd. may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
                <ul>
                <li>To comply with a legal obligation</li>
                <li>To protect and defend the rights or property of AppTwig Pvt. Ltd.</li>
                ...
                <ul>
                <li><strong>Google Analytics </strong>Google Analytics is a web analytics service offered by Google that tracks and reports website traffic. Google uses the data collected to track and monitor the use of our Service. This data is shared with other Google services. Google may use the collected data to contextualize and personalize the ads of its own advertising network.You can opt-out of having made your activity on the Service available to Google Analytics by installing the Google Analytics opt-out browser add-on. The add-on prevents the Google Analytics JavaScript (ga.js, analytics.js, and dc.js) from sharing information with Google Analytics about visits activity.For more information on the privacy practices of Google, please visit the Google Privacy &amp; Terms web page:&nbsp;<a href="https://policies.google.com/privacy?hl=en" target="_self" rel="nofollow external noopener noreferrer" data-wpel-link="external">https://policies.google.com/privacy?hl=en</a></li>
                </ul>
                ...
                <p>Our Service does not address anyone under the age of 16 (“Children”) without adult consent.</p>
                ...
                <ul>
                <li>By email: info@cyberwarriors.me</li>
                </ul>
                </div>
    </div>
</div>
